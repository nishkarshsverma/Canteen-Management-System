...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="message.php" class="main current"><span class="outer"><span class="inner media_library">Employees</span></span></a></li>  
				...
				while($row = mysqli_fetch_array($result))
					{
						...
						echo '<td><div align="left">'.$row['post'].'</div></td>';
						echo '<td><div align="left">'.$row['working_since'].'</div></td>';
