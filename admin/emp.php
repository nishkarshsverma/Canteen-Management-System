...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="emp.php" class="main current"><span class="outer"><span class="inner media_library">Employees</span></span></a></li>  
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				<thead>
					<tr>
						<th  style="border-left: 1px solid #C1DAD7" width="15%"><center> Name </center></th>
						<th width="15%"><center> Phone No. </center></th>
						<th width="30%"><center> Address </center></th>
						<!-- <th width="20%"> Payment </th> -->
						<th width="10%"><center> Post </center></th>
						<th width="10%"><center> Working Since </center></th>
				...
				$qry="SELECT * FROM message ORDER BY working_since ASC";
				$result = mysqli_query(mysqli_connect($db_host,$db_user,$db_pass,$db_database), $qry);
				while($row = mysqli_fetch_array($result))
					{
						echo '<tr class="record">';
						echo '<td style="border-left: 1px solid #C1DAD7;"><div align="center">'.$row['name'].'</div></td>';
						echo '<td><div align="center">'.$row['phone'].'</div></td>';
						echo '<td><div align="center">'.$row['address'].'</div></td>';
						// echo '<td><div align="left">'.$row['payment_mode'].'</div></td>';
						echo '<td><div align="center">'.$row['post'].'</div></td>';
						echo '<td><div align="center">'.$row['working_since'].'</div></td>';
