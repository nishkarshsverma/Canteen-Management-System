...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="products.php" class="main current"><span class="outer"><span class="inner settings">Products</span></span></a></li>        
    </ul>
</div>
<!-- MENU END -->
</div>
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editproductetails.php?id='.$row['id'].'">edit</a> | <a href="deleteproduct.php?id='.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
